...
DROP DATABASE IF EXISTS `ecommv7`;
CREATE DATABASE IF NOT EXISTS `ecommv7`;
...
VALUES ('molly','hello', 'Molly','Elizabeth','molly@xyz.com');
...
INSERT INTO App_user_user_profile (user_id, user_profile_id)
  ...
  where user.sso_id='molly' and Profile.type='ADMIN';
